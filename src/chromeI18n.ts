const FALLBACK_MESSAGES = {
  ...
  urlPlaceholder: 'https://example.com or localhost:4321',
  cleanToggle: 'Apply clean=standard',
  idleDescription: 'Analyze the active tab or enter a URL: convert HTML to Markdown and estimate AI tokens.',
  ...
  errorManualUrlInvalid: 'Invalid URL. Use http(s)://, or local hosts like localhost:4321 without scheme.',
  ...
  backendErrorLoopbackBlocked: 'This local URL was rejected by backend security policy (SSRF protection). Use a publicly reachable URL or run the backend with loopback hosts explicitly allowed.',
  backendErrorSsrfProtection: 'This destination was blocked by backend security policy (SSRF protection).',
